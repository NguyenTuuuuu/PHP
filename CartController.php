...
class CartController{
    ...
    public function updateQuantity(){
        ...
        $data = json_decode(file_get_contents("php://input"));
        if($user_id !== null && $product_id !== null && isset($data->quantity)) {
            $this->cartModel->setUserID($user_id);
            $this->cartModel->setProductID($product_id);
            $this->cartModel->setQuantity($data->quantity);
            if($this->cartModel->updateQuantity()){
                echo json_encode(array('message' => 'Cart Quantity Updated'));
            } else{
                echo json_encode(array('message' => 'Cart Quantity Not Updated'));
            }
        } else {
